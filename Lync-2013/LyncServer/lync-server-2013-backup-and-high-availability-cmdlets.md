...
---
# <a name="backup-and-high-availability-cmdlets-in-lync-server-2013"></a>Командлеты резервного копирования и высокой доступности в Lync Server 2013
...
Командлеты резервного копирования и высокой доступности позволяют администраторам управлять резервным копированием, восстановлением и возможностями высокой доступности, появившимися в Microsoft Lync Server 2013.

<div>

## <a name="backup-and-high-availability-cmdlets"></a>Командлеты резервного копирования и высокой доступности

Ниже приведен список командлетов, которые непосредственно связаны с резервным копированием и настройкой доступности вашей топологии Lync Server.

...
## <a name="in-this-section"></a>Содержание
  ...
  - [Диагностические отчеты по звонку (на пользователя) в Lync Server 2013](lync-server-2013-call-diagnostic-reports-per-user.md)   Предоставляет сведения о пользователях для неудачных сеансов одноранговых подключений и конференций.
  ...
  - [Отчеты диагностики качества мультимедиа в Lync Server 2013](lync-server-2013-media-quality-diagnostic-reports.md)   Сведения о качестве связи, а также о диагностике и устранении неполадок для неудачных вызовов.

...
---
# <a name="test-persistent-chat-server-with-a-synthetic-transaction"></a>Проверка сервера сохраняемого чата с помощью искусственной транзакции
...
Проверка постоянного сервера чата для отправки и получения сообщений в комнате чата между двумя пользователями

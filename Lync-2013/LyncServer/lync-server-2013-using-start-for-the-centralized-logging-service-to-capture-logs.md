...
> [!NOTE]
> Если вы решили использовать набор команд с ограниченными возможностями в командной строке, вы можете получить справку по CLSController.exe, введя текст <CODE>ClsController.exe</CODE> . По умолчанию <STRONG>ClsController.exe</STRONG> установлен в каталог C:\Program Files\Microsoft Lync Server 2013 \ ClsAgent.
...
## <a name="to-run-start-csclslogging-with-windows-powershell-using-basic-commands"></a>Запуск Start-CsClsLogging с помощью основных команд Windows PowerShell

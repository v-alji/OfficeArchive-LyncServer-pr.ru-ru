...
1.  Установите роль сервера федерации служб федерации Active Directory. Подробные сведения можно найти в руководстве по развертыванию служб федерации Active Directory 2,0 по адресу <https://go.microsoft.com/fwlink/p/?linkid=267511> .
...
% LocalAppData% \\ упаковывает \\ Microsoft. LyncMX \_ 8wekyb3d8bbwe \\ LocalState \\ Tracing

...
---
# <a name="lync-online-cmdlets"></a>Командлеты Lync Online
...
На этой странице перечислены все командлеты Windows PowerShell, доступные для администраторов клиентов Microsoft Lync Online.

<div>

## <a name="cmdlets-available-only-to-lync-online-administrators"></a>Командлеты, доступные только для администраторов Lync Online

Следующие командлеты можно использовать только в Lync Online:
...
Сведения о том, как настроить компьютер на использование Windows PowerShell для управления с помощью Lync Online, можно найти в разделе справки, [использующем Windows PowerShell, для управления Lync Online](https://technet.microsoft.com/library/Dn362831(v=OCS.15)).

</div>

<div>

## <a name="other-cmdlets-available-to-lync-online-administrators"></a>Другие командлеты, доступные для администраторов Lync Online

Эти командлеты можно использовать либо в Lync Online, либо в локальной версии Lync Server 2013:

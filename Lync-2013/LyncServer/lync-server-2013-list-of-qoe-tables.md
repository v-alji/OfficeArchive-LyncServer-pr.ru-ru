...
<tr class="odd">
<td><p><a href="lync-server-2013-purgesettings-table-qoe.md">PurgeSettings Table (QoE) в Lync Server 2013</a></p></td>
...
<tr class="odd">
<td><p><a href="lync-server-2013-useragentdef-table-qoe.md">UserAgentDef Table (QoE) в Lync Server 2013</a></p></td>
...
<td><p>Хранит коды URI конференций для сценариев конференции или DialogID для других сценариев.</p></td>
</tr>
<tr class="even">
...
<td><p>Сохраняет метрики качества звукового файла в линии мультимедиа. Это включает в себя метрики для подавления эха (AEC) и автоматических показателей контроля усиления (AGC).</p></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td><p><strong>Таблица DiagnosticData</strong></p></td>
...
<tr class="even">
<td><p><strong>Таблица DeviceCallSumary</strong></p></td>
<td><p>Только для внутреннего использования.</p></td>
</tr>
<tr class="odd">

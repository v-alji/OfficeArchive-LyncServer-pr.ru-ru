...
---
# <a name="persistent-chat-server-cmdlets-in-lync-server-2013"></a>Командлеты сервера сохраняемого чата в Lync Server 2013
...
Командлеты сохраняемого чата позволяют управлять службой Microsoft Lync Server 2013 (ранее известной как служба группового чата) и настраивать ее. Сохраняемый чат позволяет пользователям принимать участие в сеансах обмена мгновенными сообщениями в сети. Несмотря на то что эти сеансы могут выполняться в режиме реального времени, содержимое каждого сеанса сохраняется. Это означает, что эти беседы могут быть возобновлены кем угодно в любой момент.

<div>

## <a name="persistent-chat-cmdlets"></a>Командлеты сохраняемого чата

Командлеты сохраняемого чата позволяют управлять службой сохраняемого чата Lync Server и настраивать ее.

**Командлеты сохраняемого чата**

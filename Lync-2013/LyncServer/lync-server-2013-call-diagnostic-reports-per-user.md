...
---
# <a name="call-diagnostic-reports-per-user-in-lync-server-2013"></a>Диагностические отчеты по звонку (на пользователя) в Lync Server 2013
...
## <a name="in-this-section"></a>Содержание
  ...
  - [Отчет о действиях пользователей в Lync Server 2013](lync-server-2013-user-activity-report.md)   Сведения о одноранговых событиях и действиях конференций для каждого из пользователей.

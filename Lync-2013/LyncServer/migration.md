...
В этом разделе объясняется, как выполнить миграцию с Microsoft Office Communications Server 2007 R2 или Microsoft Lync Server 2010 на Microsoft Lync Server 2013, из Microsoft Lync Server 2010, групповой чат с Microsoft Lync Server 2013, сервера сохраняемого чата и из Microsoft Office Communications Server 2007 R2 Group Chat на сохраняемый сервер чата.

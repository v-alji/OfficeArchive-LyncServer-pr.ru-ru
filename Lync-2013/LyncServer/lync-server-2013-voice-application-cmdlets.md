---
title: 'Lync Server 2013: командлеты голосовых приложений'
description: 'Lync Server 2013: командлеты голосовых приложений.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "49438647"
---
# <a name="voice-application-cmdlets-in-lync-server-2013"></a>Командлеты голосовых приложений в Lync Server 2013
...
Голосовые приложения выполняются в службе приложений на сервере переднего плана. Эти приложения помогают управлять входящими и исходящими телефонными звонками, позволяя приостановить звонки, работать с неназначенными числами, координировать их с помощью единой системы обмена сообщениями Exchange и запускать приложение группы ответа.

<div>

## <a name="voice-application-cmdlets"></a>Командлеты голосовых приложений

Ниже приведен список командлетов, которые работают с голосовыми приложениями.

**[Командлеты приложения для приостановки звонков в Lync Server 2013](lync-server-2013-call-park-application-cmdlets.md)**
...
**[Командлеты единой системы обмена сообщениями в Lync Server 2013](lync-server-2013-exchange-um-cmdlets.md)**
...
**[Командлеты приложения группы ответа в Lync Server 2013](lync-server-2013-response-group-application-cmdlets.md)**
...
**[Неназначенные номера командлетов в Lync Server 2013](lync-server-2013-unassigned-number-cmdlets.md)**

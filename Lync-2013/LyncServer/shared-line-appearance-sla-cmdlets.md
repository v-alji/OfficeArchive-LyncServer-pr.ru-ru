...
---
# <a name="shared-line-appearance-sla-cmdlets"></a>Командлеты общего вида линии (SLA)
...
Командлеты, связанные с однострочным видом (SLA), позволяют настроить общий номер телефона с несколькими делегатами, которые могут выбрать эту строку.

<div>

## <a name="sla-cmdlets"></a>Командлеты SLA

Используйте следующие командлеты для SLA.

**Настройка соглашения об уровне обслуживания**

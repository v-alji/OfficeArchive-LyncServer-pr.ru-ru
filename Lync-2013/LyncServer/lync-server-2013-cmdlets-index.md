...
Microsoft Lync Server 2013 поставляется с более чем 700 командлетами, позволяющими администраторам управлять Lync Server 2013 из командной строки. Командлеты Lync Server обычно используются в командной консоли Lync Server Management Shell. Одним из способов использования командной консоли Lync Server является подключение к компьютеру, на котором запущена служба сервера Lync или серверная роль, нажмите кнопку **Пуск**, выберите **все программы**, а затем — **Microsoft Lync Server 2013**, а затем — **Командная консоль Lync Server Management Shell**. После открытия управляющей оболочки вы можете получить справку для командлета прямо из командной строки, введя команду, подобную следующей:
...
Чтобы получить полный список командлетов, доступных для управления Lync Server, введите в командной строке Lync Server Management Shell следующую команду:

    Get-Command * -Module Lync -CommandType cmdlet

Подробнее об использовании командной консоли Lync Server можно узнать в блоге Lync Server Windows PowerShell по адресу [https://go.microsoft.com/fwlink/p/?linkId=203150](https://go.microsoft.com/fwlink/p/?linkid=203150) .
...
Ниже приведен список командлетов, которые поставляются с Lync Server 2013:
  ...
  - [Разблокировка — CsClientPin](unhttps://technet.microsoft.com/library/Gg398650(v=OCS.15))

...
---
# <a name="user-rights-and-permissions-cmdlets-in-lync-server-2013"></a>Командлеты для доступа пользователей и разрешения в Lync Server 2013
...
Командлеты разрешений пользователей главным образом используются для управления доступом на основе ролей (RBAC), а также новыми технологиями для делегирования административного управления Microsoft Lync Server 2013.

<div>

## <a name="user-permission-cmdlets"></a>Командлеты разрешений пользователей

Ниже приведен список командлетов, непосредственно связанных с управлением разрешениями пользователей.

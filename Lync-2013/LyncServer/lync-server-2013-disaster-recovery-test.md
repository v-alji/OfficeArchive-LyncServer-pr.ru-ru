...
Чтобы выполнить резервное копирование данных рабочего сервера Lync Server 2013, выполните указанные ниже действия.
  ...
  - Создавайте резервные копии баз данных RTC и LCSLog, используя стандартный процесс резервного копирования SQL Server, чтобы выгрузить ее из файла или накопительного дампа.
  ...
  - С помощью средства командной строки Export-CsConfiguration можно создавать резервные копии параметров Lync Server 2013.

...
<p>Подробные сведения о настройке Office 365 можно найти <a href="https://go.microsoft.com/fwlink/p/?linkid=254982">в разделе Начало работы с office 365</a> и <a href="https://go.microsoft.com/fwlink/p/?linkid=254979">Настройка Office 365</a>.</p></td>
</tr>
<tr class="even">
<td></td>
<td><p>Добавление домена и проверка прав на владение доменом</p></td>
<td><p>Домен иногда также называется <em>доменом запоминающиеся</em>. Необходимо добавить домен в организацию Office 365, а затем выполнить необходимые действия для проверки домена с помощью Office 365. Это необходимо для подтверждения того, что вы являетесь владельцем домена.</p>
<p>Чтобы добавить домен в организацию Office 365, выполните действия, описанные в статье <a href="https://go.microsoft.com/fwlink/p/?linkid=254983">Добавление домена в office 365</a>.</p>

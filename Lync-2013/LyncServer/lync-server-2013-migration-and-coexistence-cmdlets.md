...
---
# <a name="migration-and-coexistence-cmdlets-in-lync-server-2013"></a>Командлеты миграции и сосуществования в Lync Server 2013
...
Командлет [Move-CsLegacyUser](https://technet.microsoft.com/library/Gg413025(v=OCS.15)) позволяет перенести учетные записи пользователей из Office Communications Server 2007 или Microsoft lync Server 2010 на Microsoft lync Server 2013. Если вам нужно переместить учетную запись пользователя в обратном направлении (например, с Microsoft Lync Server 2013 на Microsoft Lync Server 2010), используйте командлет [Move-CsUser](https://technet.microsoft.com/library/Gg398528(v=OCS.15)) .

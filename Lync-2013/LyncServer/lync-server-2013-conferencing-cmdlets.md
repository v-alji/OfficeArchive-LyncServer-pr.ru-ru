...
Microsoft Lync Server 2013 позволяет пользователям присоединяться к конференциям двумя различными способами: с помощью таких приложений, как Lync 2013, или с помощью телефонного подключения. Пользователи с телефонным подключением не могут выполнять такие действия, как просмотр слайдов и обмен мгновенными сообщениями, но они могут полностью принять участие в звуковой части Конференции.

<div>

## <a name="conferencing-cmdlets"></a>Командлеты конференц-связи

Командлеты **CsDialInConferencing** используются для настройки свойств конференц-связи с телефонным подключением, в том числе для того, чтобы присоединиться к Конференции с помощью сочетаний клавиш, которые пользователи смогут присоединиться к Конференции, после присоединения к ней (например, чтобы отключить или включить свой микрофон). Большинство других функций Конференции (например, может зафиксировать Конференц-связь, пользователи могут совместно использовать приложения на Конференции и т. д.) управляются с помощью командлетов **CsConferencingPolicy** .
...
**[Командлеты для веб-конференций в Lync Server 2013](lync-server-2013-web-conferencing-cmdlets.md)**

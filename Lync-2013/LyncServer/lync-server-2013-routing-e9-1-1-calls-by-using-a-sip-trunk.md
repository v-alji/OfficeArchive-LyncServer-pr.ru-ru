...
На приведенной ниже схеме показано, как вызов экстренной помощи с сервера Lync Server передается на точку ответа на общедоступную безопасность (PSAP) при использовании магистральной магистрали SIP и поставщика услуг с квалифицированным E9 1-1.

...
В этой статье содержатся термины и определения, относящиеся к Microsoft Lync Server 2013 и Microsoft Lync 2013.
...
<td><p>Сторона (пользователь или расположение), которой звонит абонент.</p></td>
</tr>
<tr class="odd">
...
<td><p>Служба, которая предоставляет сведения о местонахождении абонента, звонящего по номеру 911.</p></td>
</tr>
<tr class="even">
...
<tr class="even">
<td><p>конференц-связи с использованием обмена мгновенными сообщениями</p></td>
...
<td><p>Узел сети, изначально определенный организацией National Emergency Number Association в сетевой архитектуре i2, которая представляет собой промежуточное решение для предоставления службы Enhanced 9-1-1 (E911) пользователям телефонии VoIP. </p></td>
</tr>
<tr class="odd">
<td><p>информирования о местонахождении</p></td>
<td><p>Веб-служба, управляющая таблицей элементов сети и расположениями для использования клиентами службы Enhanced 9-1-1 (E911).</p></td>
</tr>
<tr class="even">
<td><p>длинное сообщение</p></td>
<td><p>Сообщение в комнате сохраняемого чата, длина которого в символах превышает предельное значение. Если превышено ограничение на количество знаков, сообщение будет отображаться как &quot; длинное сообщение.&quot;</p></td>
</tr>
<tr class="odd">
...
<td><p>Обозначает вариант работы с Lync и может быть как запланированным, так и незапланированным. Собрание Lync предоставляет возможность взаимодействовать с людьми посредством видео, звука, обмена мгновенными сообщениями и общего доступа к содержимому. </p></td>
</tr>
<tr class="odd">
<td><p>окно собрания Lync</p></td>
<td><p>Обозначает окно беседы, которое обрабатывает эскалации (с однорангового сеанса до конференции) и масштабируемые представления, которые отображают людей и содержимое в рамках собрания Lync.</p></td>
</tr>
<tr class="even">
...
<td><p>Сетевые концентраторы или магистрали, используемые в конфигурации контроля допуска звонков, E911 и обхода сервера-посредника. Они связывают части сети в рамках нескольких географических областей, при этом каждая область сети должна быть сопоставлена с центральным сайтом.</p></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td><p>Записи использования ТСОП</p></td>
...
<tr class="even">
<td><p>для обеспечения связи в филиалах</p></td>
...
<tr class="odd">
<td><p>обслуживания пользователей</p></td>

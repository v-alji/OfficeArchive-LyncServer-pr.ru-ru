...
<td><p>По внешнему краю обратного прокси-сервера связь передается в каталог HLB VIP и на сервер переднего плана.</p></td>
</tr>
<tr class="even">
...
<td><p>Межсерверная связь между директором HLB VIP и сервером переднего плана и серверами переднего плана.</p></td>
</tr>
<tr class="even">

...
<td><p>Если запись DNS SRV недоступна, то для обнаружения регистратора клиент будет пытаться использовать параметр DHCP 120. Для этого необходимо настроить DHCP-сервер или включить поддержку протокола "Lync Server 2013". Дополнительные сведения: требования к оборудованию и программному обеспечению для обеспечения устойчивости Branch-Site на <a href="lync-server-2013-branch-site-resiliency-requirements.md">сайте Lync Server 2013</a> .</p></td>
</tr>
</tbody>
</table>

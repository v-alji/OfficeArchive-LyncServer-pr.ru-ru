...
---
# <a name="sample-qoe-database-queries-in-lync-server-2013"></a>Образцы запросов к базе данных качества взаимодействия в Lync Server 2013
...
Следующий пример используется для получения ConversstionalMOS, SendingMOS и ListendingMOS для каждого устройства захвата.

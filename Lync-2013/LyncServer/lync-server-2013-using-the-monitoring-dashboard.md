...
Обратите внимание, что для получения URL-адреса, используемого для доступа к отчетам мониторинга Lync Server 2013, можно использовать командлет [Get-CsReportingConfiguration](https://docs.microsoft.com/powershell/module/skype/Get-CsReportingConfiguration) :

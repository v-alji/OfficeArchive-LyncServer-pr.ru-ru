...
---
# <a name="get-persistent-chat-server-pool-availability-in-lync-server-2013"></a>Получение сведений о доступности пула сервера сохраняемого чата в Lync Server 2013
...
Получение сведений о доступности пула серверов для постоянного чата

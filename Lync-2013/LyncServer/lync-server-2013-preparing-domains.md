...
Дополнительные сведения о командлете **Grant-CsOuPermission** можно найти в документации по оболочке Lync Server Management Shell.

...
---
# <a name="centralized-logging-cmdlets-in-lync-server-2013"></a>Командлеты централизованного ведения журналов в Lync Server 2013
...
<!-- end list -->
  ...
  - [Остановить-CsClsLogging](https://technet.microsoft.com/library/JJ619180(v=OCS.15))

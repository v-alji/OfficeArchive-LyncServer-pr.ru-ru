---
title: 'Lync Server 2013: командлеты ролей и служб сервера'
description: 'Lync Server 2013: командлеты серверных ролей и служб.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "49444884"
---
# <a name="server-roles-and-services-cmdlets-in-lync-server-2013"></a>Командлеты серверных ролей и служб в Lync Server 2013
...
Многие компоненты Microsoft Lync Server 2013 выполняются как роли сервера или как службы. Lync Server 2013 поставляется с набором командлетов, позволяющих управлять этими ролями и службами сервера.

<div>

## <a name="server-roles-and-services-cmdlets"></a>Командлеты служб и ролей сервера

Многие (но не все) задачи управления, применимые к серверам и ролям служб, можно выполнить с помощью панели управления Lync Server. Например, вы можете управлять архивацией параметров сервера, но не параметрами сервера адресной книги с помощью панели управления Lync Server. Тем не менее, все эти задачи можно выполнить с помощью командлетов из командной консоли Lync Server Management Shell или в сценарии. Использование сценария позволяет автоматизировать определенные задачи. Ниже приведен список командлетов, непосредственно связанных с управлением ролями и службами сервера.

**[Командлеты сервера адресной книги в Lync Server 2013](lync-server-2013-address-book-server-cmdlets.md)**
...
**[Архивация и мониторинг командлетов в Lync Server 2013](lync-server-2013-archiving-and-monitoring-cmdlets.md)**
...
**[Командлеты сервера баз данных и управления в Lync Server 2013](lync-server-2013-database-and-management-server-cmdlets.md)**
...
**[Другие командлеты роли сервера в Lync Server 2013](lync-server-2013-other-server-role-cmdlets.md)**
...
**[Командлеты регистраторов и режиссеры в Lync Server 2013](lync-server-2013-registrar-and-director-cmdlets.md)**
...
<!-- end list -->
  ...
  - <span></span>  
    [Остановить-CsWindowsService](https://technet.microsoft.com/library/Gg398426(v=OCS.15))

**[Устранение неполадок с командлетами ролей и служб сервера в Lync Server 2013](lync-server-2013-troubleshooting-server-roles-and-services-cmdlets.md)**

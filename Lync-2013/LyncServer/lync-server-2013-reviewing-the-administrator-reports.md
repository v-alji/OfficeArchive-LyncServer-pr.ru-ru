...
---
# <a name="reviewing-the-administrator-reports-in-lync-server-2013"></a>Просмотр отчетов администратора в Lync Server 2013
...
## <a name="in-this-section"></a>Содержание
  ...
  - [Просмотр отчета о брандмауэре в Lync Server 2013](lync-server-2013-reviewing-the-firewall-report.md)

  - [Просмотр отчета DNS в Lync Server 2013](lync-server-2013-reviewing-the-dns-report.md)

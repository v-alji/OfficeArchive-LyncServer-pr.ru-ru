...
---
# <a name="deploying-lync-for-windows-phone-in-lync-server-2013"></a>Развертывание Lync для Windows Phone в Lync Server 2013
...
В этом разделе рассказывается, как развернуть Lync 2013 для Windows Phone для мобильных пользователей.

<div>

## <a name="in-this-section"></a>Содержание

  - [Установка Lync для Windows Phone в Lync Server 2013](lync-server-2013-installing-lync-for-windows-phone.md)

  - [Удаление Lync для Windows Phone в Lync Server 2013](lync-server-2013-removing-lync-for-windows-phone.md)

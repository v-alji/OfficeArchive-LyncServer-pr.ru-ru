...
Благодаря интеграции пользователи локального развертывания могут взаимодействовать с Microsoft 365 или Office 365 в своей организации. Чтобы настроить федерацию, выполните следующие командлеты:
...
```
Чтобы установить удаленный сеанс PowerShell в Skype для бизнеса Online, необходимо сначала установить модуль Skype для бизнеса Online для Windows PowerShell, который вы можете найти [https://go.microsoft.com/fwlink/p/?LinkId=391911](https://go.microsoft.com/fwlink/p/?linkid=391911) ниже.

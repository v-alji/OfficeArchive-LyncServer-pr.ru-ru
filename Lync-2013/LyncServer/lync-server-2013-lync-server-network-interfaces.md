...
---
# <a name="lync-server-2013-network-interfaces"></a>Сетевые интерфейсы Lync Server 2013
...
## <a name="in-this-section"></a>Содержание
  ...
  - [Просмотр сведений о сетевом интерфейсе в Lync Server 2013](lync-server-2013-viewing-network-interface-information.md)

...
---
# <a name="exchange-um-cmdlets-in-lync-server-2013"></a>Командлеты единой системы обмена сообщениями в Lync Server 2013
...
Microsoft Lync Server 2013 работает вместе с единой системой обмена сообщениями Exchange (UM) для реализации автосекретаря и абонентского доступа для размещенной голосовой почты. Эти возможности можно управлять с помощью командлетов в командной консоли Lync Server.

<div>

## <a name="exchange-um-cmdlets"></a>Командлеты Exchange UM

Для управления UM Exchange можно использовать следующие командлеты.

...
---
# <a name="mobile-client-deployment-process-in-lync-server-2013"></a>Процесс развертывания мобильных клиентов в Lync Server 2013
...
## <a name="lync-mobile-deployment-process"></a>Процесс развертывания Lync Mobile

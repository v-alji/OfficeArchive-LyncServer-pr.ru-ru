...
ms.locfileid: "49399118"
---
# <a name="pstn-connectivity-cmdlets-in-lync-server-2013"></a>Командлеты подключения PSTN в Lync Server 2013
...
Корпоративная голосовая связь предоставляет параметры, позволяющие звонить через общедоступную телефонную сеть (PSTN), не отменяя качество обслуживания (QoS). Эти параметры можно настроить с помощью командлетов, доступных в командной консоли Lync Server Management Shell.

<div>

## <a name="pstn-connectivity-cmdlets"></a>Командлеты подключения PSTN

Используйте указанные ниже командлеты, чтобы настроить различные аспекты подключения КТСОП.

**[Командлеты PSTN Gateway в Lync Server 2013](lync-server-2013-pstn-gateways-cmdlets.md)**
...
**[Командлеты статической маршрутизации в Lync Server 2013](lync-server-2013-static-routing-cmdlets.md)**
...
**[Командлеты конфигурации для магистрали в Lync Server 2013](lync-server-2013-trunking-configuration-cmdlets.md)**

...
---
# <a name="configuring-two-factor-authentication-in-lync-server-2013"></a>Настройка двухфакторной проверки подлинности в Lync Server 2013
...
В следующих разделах приведена пошаговая процедура настройки двухфакторной проверки подлинности для развертывания. 

<div>

## <a name="in-this-section"></a>Содержание

[Настройка ЦС предприятия для проверки подлинности с помощью смарт-карты в Lync Server 2013](lync-server-2013-configuring-enterprise-ca-for-smart-card-authentication.md)

[Настройка Windows 8 для использования виртуальных смарт-карт с Lync Server 2013](lync-server-2013-configuring-windows-8-for-virtual-smart-cards.md)

[Регистрация пользователей для проверки подлинности с помощью смарт-карты в Lync Server 2013](lync-server-2013-enrolling-users-for-smart-card-authentication.md)

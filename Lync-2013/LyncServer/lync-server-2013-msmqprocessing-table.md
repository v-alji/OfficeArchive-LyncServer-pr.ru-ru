...
---
# <a name="msmqprocessing-table-in-lync-server-2013"></a>Таблица MSMQProcessing в Lync Server 2013
...
Таблица MSMQProcessing предназначена только для внутреннего использования. Эта таблица введена в Microsoft Lync Server 2013.

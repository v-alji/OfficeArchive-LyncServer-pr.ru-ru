...
---
# <a name="managing-lync-server-2013-services"></a>Управление службами Lync Server 2013
...
Чтобы управлять службами Lync Server 2013 на странице **Topology** , выполните действия, описанные в этом разделе.

...
В UM Exchange есть функции факса, позволяющие пользователям принимать входящие факсы в почтовые ящики Exchange. Подробности можно найти в разделе "Единая система обмена сообщениями" в документации по серверу Microsoft Exchange Server по адресу [https://go.microsoft.com/fwlink/p/?linkId=135652](https://go.microsoft.com/fwlink/p/?linkid=135652) .

...
---
# <a name="useragentdef-table-in-lync-server-2013"></a>Таблица UserAgentDef в Lync Server 2013
...
В таблице UserAgentDef идентификаторы агентов пользователя сопоставлены с описательными именами агента. Агенты пользователей — это клиенты программного обеспечения, используемые для подключения к Microsoft Lync Server 2013. Эта таблица введена в Microsoft Lync Server 2013.

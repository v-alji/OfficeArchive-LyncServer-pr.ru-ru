...
<tr class="odd">
<td><p>Test-CsIM (МГНОВЕННЫЕ СООБЩЕНИЯ)</p></td>
...
<td><p>Подтверждение того, что мгновенное сообщение может быть отправлено через шлюз XMPP (Extensible Messaging Protocol и протокол присутствия).</p></td>
<td><p>Не по умолчанию</p></td>
</tr>
</tbody>
</table>
...
> [!NOTE]  
> Кроме того, администраторы могут выполнять синтетические транзакции вручную, не требуя использования или установки Operations Manager. Сведения о различных командлетах Test-Cs можно найти в <A href="https://docs.microsoft.com/powershell/module/skype/?view=skype-ps">индексе командлетов Lync Server 2013</A>.
